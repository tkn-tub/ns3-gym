...
private:
  ...
  static EventId Schedule (Time const &time, Ptr<EventImpl> event);
  static EventId ScheduleDestroy (Ptr<EventImpl> event);
  static EventId ScheduleNow (Ptr<EventImpl> event);
