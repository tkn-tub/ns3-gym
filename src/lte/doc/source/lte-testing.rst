...
:math:`p=1-BER` and :math:`n` is the total number of packet sent.

The error model of PCFICH-PDDCH channels consists of 4 test cases with a single
...
The test verifies that the error on the data received respects the
decodification error probability of the PCFICH-PDCCH with a tolerance of 0.1 due
to the errors that might be produced in quantizing the MI and the error curve.
