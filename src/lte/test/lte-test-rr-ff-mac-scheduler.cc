  ...
  : TestSuite ("lte-rr-ff-mac-scheduler", SYSTEM)
{
  ...
  AddTestCase (new LenaRrFfMacSchedulerTestCase (1,0,0,2196000,2292000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (3,0,0,749000,749000), TestCase::QUICK);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (6,0,0,373000,373000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (9,0,0,185000,185000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (12,0,0,185000,185000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (15,0,0,148000,89000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaRrFfMacSchedulerTestCase (1,0,3000,1383000,1239000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (3,0,3000,469000,389000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (6,0,3000,233000,193000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (9,0,3000,113000,97000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (12,0,3000,113000,97000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (15,0,3000,90400,47000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaRrFfMacSchedulerTestCase (1,0,6000,903000,621000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (3,0,6000,309000,201000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (6,0,6000,153000,97000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (9,0,6000,75000,47000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (12,0,6000,75000,47000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (15,0,6000,60000,22000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaRrFfMacSchedulerTestCase (1,0,9000,597000,437000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (3,0,9000,201000,137000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (6,0,9000,97000,67000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (9,0,9000,47000,32000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (12,0,9000,47000,32000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (15,0,9000,37600,15000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaRrFfMacSchedulerTestCase (1,0,15000,309000,233000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (3,0,15000,101000,69000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (6,0,15000,49000,32000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (9,0,15000,22000,15000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (12,0,15000,22000,15000), TestCase::EXTENSIVE);
  AddTestCase (new LenaRrFfMacSchedulerTestCase (15,0,15000,17600,7000), TestCase::EXTENSIVE);
