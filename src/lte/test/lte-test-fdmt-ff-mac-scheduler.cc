  ...
  : TestSuite ("lte-fdmt-ff-mac-scheduler", SYSTEM)
{
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1,0,0,2196000,2292000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (3,0,0,2196000,749000), TestCase::QUICK);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (6,0,0,2196000,373000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (12,0,0,2196000,185000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (15,0,0,2196000,89000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1,0,3000,1383000,1239000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (3,0,3000,1383000,389000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (6,0,3000,1383000,193000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (12,0,3000,1383000,97000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (15,0,3000,1383000,47000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1,0,6000,903000,621000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (3,0,6000,903000,201000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (6,0,6000,903000,97000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (12,0,6000,903000,47000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (15,0,6000,903000,22000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1,0,9000,597000,437000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (3,0,9000,597000,137000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (6,0,9000,597000,67000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (12,0,9000,597000,32000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (15,0,9000,597000,15000), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1,0,15000,309000,233000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (3,0,15000,309000,69000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (6,0,15000,309000,32000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (12,0,15000,309000,15000), TestCase::EXTENSIVE);
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (15,0,15000,309000,7000), TestCase::EXTENSIVE);
