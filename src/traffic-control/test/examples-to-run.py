...
cpp_examples = [
    ...
    ("adaptive-red-tests --testNumber=2", "True", "False"),
    ("adaptive-red-tests --testNumber=6", "True", "False"),
    ("adaptive-red-tests --testNumber=7", "True", "False"),
    ("adaptive-red-tests --testNumber=8", "True", "False"),
    ("adaptive-red-tests --testNumber=9", "True", "False"),
    ("adaptive-red-tests --testNumber=10", "True", "False"),
    ("adaptive-red-tests --testNumber=12", "True", "False"),
    ("adaptive-red-tests --testNumber=13", "True", "False"),
    ("adaptive-red-tests --testNumber=14", "True", "False"),
    ("adaptive-red-tests --testNumber=15", "True", "False"),
