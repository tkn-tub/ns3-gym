...
def register_Ns3CidFactory_methods(root_module, cls):
    ...
    ## cid-factory.h: ns3::CidFactory::CidFactory(uint16_t m) [constructor]
    cls.add_constructor([param('uint16_t', 'm')])
...
def register_Ns3OfdmDcdChannelEncodings_methods(root_module, cls):
    ...
    cls.add_method('GetChannelNr', 
                   ...
                   [], 
                   is_const=True)
    ## dl-mac-messages.h: uint32_t ns3::OfdmDcdChannelEncodings::GetChnlSwitchFrameNr() const [member function]
    cls.add_method('GetChnlSwitchFrameNr', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ...
    ## dl-mac-messages.h: void ns3::OfdmDcdChannelEncodings::SetChnlSwitchFrameNr(uint32_t chnlSwitchFrameNr) [member function]
    cls.add_method('SetChnlSwitchFrameNr', 
                   'void', 
                   [param('uint32_t', 'chnlSwitchFrameNr')])
...
def register_Ns3SSRecord_methods(root_module, cls):
    ...
    cls.add_method('GetBasicCid', 
                   ...
                   [], 
                   is_const=True)
    ## ss-record.h: uint8_t ns3::SSRecord::GetDsaReqRetries() const [member function]
    cls.add_method('GetDsaReqRetries', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ...
    cls.add_method('GetSfTransactionId', 
                   ...
                   [], 
                   is_const=True)
    ## ss-record.h: void ns3::SSRecord::IncrementDsaReqRetries() [member function]
    cls.add_method('IncrementDsaReqRetries', 
                   'void', 
                   [])
    ...
    cls.add_method('IncrementRangingCorrectionRetries', 
                   'void', 
                   [])
    ## ss-record.h: void ns3::SSRecord::ResetDsaReqRetries() [member function]
    cls.add_method('ResetDsaReqRetries', 
                   'void', 
                   [])
...
def register_Ns3ServiceFlowManager_methods(root_module, cls):
    ...
    cls.add_method('GetServiceFlows', 
                   ...
                   [param('ns3::ServiceFlow::SchedulingType', 'schedulingType')], 
                   is_const=True)
    ## service-flow-manager.h: void ns3::ServiceFlowManager::defineServiceFlow() [member function]
    cls.add_method('defineServiceFlow', 
                   'void', 
                   [])
    return
...
def register_Ns3SsServiceFlowManager_methods(root_module, cls):
    ...
    cls.add_method('AddServiceFlow', 
                   'void', 
                   [param('ns3::ServiceFlow', 'serviceFlow')])
    ## ss-service-flow-manager.h: void ns3::SsServiceFlowManager::AllocateServiceFlows(ns3::DsaReq const & dsaReq, ns3::Cid cid) [member function]
    ...
    cls.add_method('GetMaxDsaReqRetries', 
                   ...
                   [], 
                   is_const=True)
    ## ss-service-flow-manager.h: uint8_t ns3::SsServiceFlowManager::GetMaxDsaRspRetries() const [member function]
    cls.add_method('GetMaxDsaRspRetries', 
                   'uint8_t', 
                   [], 
                   is_const=True)
...
def register_Ns3WimaxPhy_methods(root_module, cls):
    ...
    ## wimax-phy.h: void ns3::WimaxPhy::StartScanning(uint64_t frequency, ns3::Time timeout, ns3::Callback<void, bool, unsigned long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
...
def register_Ns3DsaRsp_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## mac-messages.h: ns3::DsaRsp::DsaRsp(ns3::ServiceFlow sf) [constructor]
    cls.add_constructor([param('ns3::ServiceFlow', 'sf')])
...
def register_Ns3WimaxNetDevice_methods(root_module, cls):
    ## wimax-net-device.h: ns3::WimaxNetDevice::WimaxNetDevice(ns3::WimaxNetDevice const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::WimaxNetDevice const &', 'arg0')])
    ...
    cls.add_method('GetMaxMsduSize', 
                   ...
                   [], 
                   is_const=True)
    ## wimax-net-device.h: ns3::Ptr<ns3::Object> ns3::WimaxNetDevice::GetMobility() [member function]
    cls.add_method('GetMobility', 
                   'ns3::Ptr< ns3::Object >', 
                   [])
    ...
    ## wimax-net-device.h: void ns3::WimaxNetDevice::SetMobility(ns3::Ptr<ns3::Object> mobility) [member function]
    cls.add_method('SetMobility', 
                   'void', 
                   [param('ns3::Ptr< ns3::Object >', 'mobility')])
...
def register_Ns3BaseStationNetDevice_methods(root_module, cls):
    ## bs-net-device.h: ns3::BaseStationNetDevice::BaseStationNetDevice(ns3::BaseStationNetDevice const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::BaseStationNetDevice const &', 'arg0')])
    ...
    cls.add_method('GetLinkManager', 
                   ...
                   [], 
                   is_const=True)
    ## bs-net-device.h: uint8_t ns3::BaseStationNetDevice::GetMaxDsaReqRetries() const [member function]
    cls.add_method('GetMaxDsaReqRetries', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ...
    ## bs-net-device.h: void ns3::BaseStationNetDevice::SetMaxDsaReqRetries(uint8_t maxDsaResponseRetries) [member function]
    cls.add_method('SetMaxDsaReqRetries', 
                   'void', 
                   [param('uint8_t', 'maxDsaResponseRetries')])
...
def register_Ns3SubscriberStationNetDevice_methods(root_module, cls):
    ## ss-net-device.h: ns3::SubscriberStationNetDevice::SubscriberStationNetDevice(ns3::SubscriberStationNetDevice const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SubscriberStationNetDevice const &', 'arg0')])
